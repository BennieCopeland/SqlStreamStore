namespace SqlStreamStore.Postgres
{
    ...
    public class PostgresStreamStore : StreamStoreBase
    {
        ...
        protected override Task<ReadAllPage> ReadAllForwardsInternal(long fromPositionExlusive, int maxCount, bool prefetch, AllStreamFilter filter, ReadNextAllPage readNext, CancellationToken cancellationToken)
        {
